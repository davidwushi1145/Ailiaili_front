...
declare global {
  ...
  const getDynamicFeed: typeof import('./src/utils/getDynamicFeed')['getDynamicFeed']
  const getFollows: typeof import('./src/utils/getFollows')['getFollows']
  const getHistoryVideos: typeof import('./src/utils/getHistoryVideos')['getHistoryVideos']
  const getPlayUrl: typeof import('./src/utils/getPlayurl')['getPlayUrl']
  const getPopurlarVideos: typeof import('./src/utils/getPopularVideos')['getPopurlarVideos']
  ...
  const getVideoInfo: typeof import('./src/utils/getVideoInfo')['getVideoInfo']
  const getVideoRelate: typeof import('./src/utils/getVideoRelated')['getVideoRelate']
  ...
  const logout: typeof import('./src/utils/logout')['logout']
  ...
  const useDataLoadmore: typeof import('./src/composables/useDataLoadmore')['useDataLoadmore']
  const useDataWithAid: typeof import('./src/composables/useDataWithAid')['useDataWithAid']
  ...
  const usePlayURL: typeof import('./src/composables/usePlayURL')['usePlayURL']
